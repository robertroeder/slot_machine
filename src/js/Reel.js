...
export default class Reel {
  ...
  clearBlink(){
    this.symbolContainer.children[0].classList.remove('blinker'); 
    this.symbolContainer.children[1].classList.remove('blinker'); 
    this.symbolContainer.children[2].classList.remove('blinker'); 
  ...
  blink(positions) {
    ...
    for(let i of positions){
      this.symbolContainer.children[i].classList.add('blinker'); 
    }
  }
}
